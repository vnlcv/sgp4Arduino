...
void setup() {
  ...
  double jdC = sat.satrec.jdsatepoch; //retrieves Julian date of the satellite's epoch from the 'sat' object
  invjday(jdC , timezone, true, year, mon, day, hr, minute, sec); //converts the Julian date (jdC) to calendar date
